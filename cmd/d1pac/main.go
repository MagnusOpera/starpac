...
import (
	...
	"github.com/MagnusOpera/d1pac/internal/apply"
	"github.com/MagnusOpera/d1pac/internal/cloudflare"
	...
	"github.com/MagnusOpera/d1pac/internal/packagefmt"
	"github.com/MagnusOpera/d1pac/internal/projectxml"
	"github.com/MagnusOpera/d1pac/internal/render"
)
...
func resolvePackageOutput(outputPath, packageID string) (string, error) {
	...
	if strings.HasSuffix(strings.ToLower(outputPath), ".d1pkg") {
	...
	return filepath.Join(outputPath, packageID+".d1pkg"), nil
}

...
the spirit of `sqlpackage` and [`pgpac`](https://github.com/MagnusOpera/pgpac).
...
Documentation website: <https://magnusopera.github.io/d1pac/>
...
make test
make sample
make release-build version=0.0.0-dev
